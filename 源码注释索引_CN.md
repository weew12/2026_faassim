...
Sphinx 文档构建配置，设置文档主题、扩展、静态资源和项目元信息，用于生成官方文档页面。

## `examples/__init__.py`

faas-sim 示例代码，展示某一类仿真组件如何被装配、运行和分析。
...
基础示例，展示如何创建拓扑、注册镜像、定义函数部署、部署函数并发起简单请求负载。

类：ExampleBenchmark

函数：main、example_topology

## `examples/custom_function_sim/__init__.py`

faas-sim 示例代码，展示某一类仿真组件如何被装配、运行和分析。

## `examples/custom_function_sim/main.py`

自定义函数模拟器示例，演示如何实现 FunctionSimulator 生命周期方法并接入 SimulatorFactory。

类：CustomSimulatorFactory、MyFunctionSimulator

函数：main

## `examples/custom_scheduler/__init__.py`

faas-sim 示例代码，展示某一类仿真组件如何被装配、运行和分析。

## `examples/custom_scheduler/main.py`

自定义调度器示例，演示如何替换默认调度逻辑并将副本放置到指定节点。

类：CustomScheduler

函数：main

## `examples/request_gen/__init__.py`

faas-sim 示例代码，展示某一类仿真组件如何被装配、运行和分析。

## `examples/request_gen/main.py`

请求生成器示例，展示固定/正弦等到达模式如何驱动函数调用实验。

类：ExampleBenchmark

函数：main、example_topology

## `examples/watchdogs/__init__.py`

faas-sim 示例代码，展示某一类仿真组件如何被装配、运行和分析。

## `examples/watchdogs/inference.py`

推理函数模拟器示例，模拟模型加载、推理资源占用和请求执行耗时。

类：InferenceFunctionSim

## `examples/watchdogs/main.py`

watchdog 示例入口，组合训练和推理函数模拟器，展示 OpenFaaS HTTP/Fork 风格执行模型。

类：AIFunctionSimulatorFactory、TrainInferenceBenchmark

函数：main

## `examples/watchdogs/training.py`

训练函数模拟器示例，模拟训练任务的启动、资源占用、执行和释放过程。

类：TrainingFunctionSim
